...
class AXISPIMASTERWrapper(Module):
    def __init__(self, platform, data_width, addr_width, id_width, user_width, buffer_depth):
        ...
        # AXI SPI MASTER -----------------------------------------------------------------------
        self.submodules.spi_master = spi_master = AXISPIMASTER(platform, axil,
            data_width      = data_width,
...
def main():
    ...
    core_group.add_argument("--user_width",        default=4,     type=int,       help="AXI ID Width 1 - 8")
    core_group.add_argument("--id_width",          default=16,    type=int,       help="AXI ID Width 1 - 16")
    core_group.add_argument("--buffer_depth",      default=8,     type=int,       help="AXI Buffer Depth 8")
