...
# LiteX wrapper around RapidSilicon axi_spi_master
...
class AXISPIMASTER(Module):
    def __init__(self, platform, s_axi, addr_width, data_width, user_width, id_width, buffer_depth ):
