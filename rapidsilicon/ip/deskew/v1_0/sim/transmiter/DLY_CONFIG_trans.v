...
//`include "/nfs_scratch/scratch/AE/Roman/deskew_dev/deskew_example/transmiter/src/header_trans.vh"
`define PLL
`define LOCAL_OSCILLATOR
`define O_SERDES_O_DELAY
`define SINGLE_ENDED

module DLY_CONFIG_trans #(
    // IO_BUF
