...
class PLL(Module):
    def __init__(self, platform, divide_clk_in_by_2, fast_clk_freq, ref_clk_freq, clk_div_1, clk_div_2, clk_div_3, clk_div_4, **kwargs):
...
#        self.logger.info(f"PLL_DIV              : {pll_div}")
        ...
        self.specials += Instance("PLL",
                    **kwargs,
                    ...
                    p_CLK_DIV_1             = Instance.PreformattedParam(1),
                    p_CLK_DIV_2             = Instance.PreformattedParam(2),
                    p_CLK_DIV_3             = Instance.PreformattedParam(3),
                    p_CLK_DIV_4             = Instance.PreformattedParam(4),
