...
class AXIREGISTER(Module):
    def __init__(self, platform, s_axi, m_axi, size=1024,
        ...
        self.specials += Instance("axi_register",
            ...
            # Channel Reg Type
            p_AW_REG_TYPE      = Instance.PreformattedParam(aw_reg_type),
            p_W_REG_TYPE       = Instance.PreformattedParam(w_reg_type),
            p_B_REG_TYPE       = Instance.PreformattedParam(b_reg_type),
            p_AR_REG_TYPE      = Instance.PreformattedParam(ar_reg_type),
            p_R_REG_TYPE       = Instance.PreformattedParam(r_reg_type),
