...
def main():
    ...
    core_range_param_group.add_argument("--full_value",     type=int,   default=1,	choices=range(1,4095),  help="Full Value")
    core_range_param_group.add_argument("--empty_value",    type=int,   default=0,  	choices=range(0,4095),  help="Empty Value")
