...
class FIFO(Module):
    def __init__(self, data_width_write, data_width_read, synchronous, full_threshold, empty_threshold, depth, first_word_fall_through, empty_value, full_value, builtin_fifo):
        ...
        if (builtin_fifo):
                                        ...
                                        if (count + l < num_36K + (num_18K/2)*2 + (num_9K/4)*2):
                                            ...
                                            if (count + l == 0):
                                                self.sync.rd += [
                                                    If(self.rden,
                                                       If(~self.empty,
                                                            If(self.rd_ptr[0: -1] < ((count + 1 + l)*read_memory) + int(starting) - 1,
                                                              If(self.rd_ptr[0: -1] >= ((count + l)*read_memory) + int(starting),
                                                                self.rden_int[count + l].eq(1)
                                                ...
                                                self.sync.rd += [
                                                    If(self.rden,
                                                       If(~self.empty,
                                                            If(self.rd_ptr[0: -1] < ((count + 1 + l)*read_memory) + int(starting) - 1,
                                                              If(self.rd_ptr[0: -1] >= ((count + l)*read_memory) + int(starting) - 1,
                                                                self.rden_int[count + l].eq(1)
                                                                ).Else(self.rden_int[count + l].eq(0))
                                                            ).Else(self.rden_int[count + l].eq(0))
                                                        ).Else(self.rden_int[count + l].eq(0))
                                            ...
                                            self.sync.rd += [
                                                If(self.rd_en_flop1,
                                                   If(~self.underflow,
                                                        If(self.rd_ptr[0: -1] < ((count + 1 + l)*memory) + int(starting),
                                                          If(self.rd_ptr[0: -1] >= ((count + l)*memory) + int(starting),
                                                                self.dout[j:data_read + j].eq(self.dout_int[count + l])
                                                        )
                                                      )
                                                   )
                                            ...
                                            if (first_word_fall_through):
                                                self.sync.rd += [
                                                    If(~self.rden,
                                                        If(~self.empty_int[count + l],
                                                            If(self.rd_ptr[0: -1] <= int((count + 1 + l)*read_memory) + int(starting),
                                                                If(self.rd_ptr[0: -1] >= int((count + l)*read_memory) + int(starting),
                                                                    self.dout[j:data_write + j].eq(self.dout_int[count + l]
                                                                    )
                                                                )
                                                            )
                                                ...
                                                if (k18_flag_read):
                                                    if ((count + l + count_36K == 0) or (count_36K > 0 and l == 0 and (count9K_read == 0))):
                                                        self.sync.rd += [
                                                            If(self.rden,
                                                               If(~self.empty,
                                                                    If(self.rd_ptr[0: -1] < int((k_loop_read + 1 + l + two_block_read )*memory) + int(starting) - 1,
                                                                      If(self.rd_ptr[0: -1] >= int((k_loop_read + l + two_block_read )*memory) + int(starting),
                                                                        self.rden_int[count + l].eq(1)
                                                                        ).Else(self.rden_int[count + l].eq(0))
                                                                    ).Elif(self.rd_ptr[0: -1] == int(ending),
                                                                               self.rden_int[count + l].eq(1)
                                                        ...
                                                        self.sync.rd += [
                                                            If(self.rden,
                                                               If(~self.empty,
                                                                    If(self.rd_ptr[0: -1] < int((k_loop_read + 1 + l + two_block_read )*memory) + int(starting) - 1,
                                                                      If(self.rd_ptr[0: -1] >= int((k_loop_read + l + two_block_read )*memory) + int(starting) - 1,
                                                                        self.rden_int[count + l].eq(1)
                                                                        ).Else(self.rden_int[count + l].eq(0))
                                                                    ).Else(self.rden_int[count + l].eq(0))
                                                                ).Else(self.rden_int[count + l].eq(0))
                                                    ...
                                                    self.sync.rd += [
                                                        If(self.rd_en_flop1,
                                                           If(~self.underflow,
                                                                If(self.rd_ptr[0: -1] < int((k_loop_read + 1 + l + two_block_read)*memory) + int(starting),
                                                                  If(self.rd_ptr[0: -1] >= int((k_loop_read + l + two_block_read)*memory) + int(starting),
                                                                        self.dout[j:data_read + j].eq(self.dout_int[count + l])
                                                                )
                                                              )
                                                    ...
                                                    if ((count + l + count_36K == 0) or (count_36K > 0 and l == 0 and (count18K_read + count9K_read == 0))):
                                                        self.sync.rd += [
                                                            If(self.rden,
                                                               If(~self.empty,
                                                                    If(self.rd_ptr[0: -1] < ((k_loop_read + 1 + l + two_block_read + count9K_read)*memory)*int(data_width_write/data_width_read) + int(starting) - 1,
                                                                      If(self.rd_ptr[0: -1] >= ((k_loop_read + l + two_block_read + count9K_read)*memory)*int(data_width_write/data_width_read) + int(starting),
                                                                        self.rden_int[count + l].eq(1)
                                                                        ).Else(self.rden_int[count + l].eq(0))
                                                                    ).Elif(self.rd_ptr[0: -1] == int(ending),
                                                                               self.rden_int[count + l].eq(1)
                                                        ...
                                                        self.sync.rd += [
                                                            If(self.rden,
                                                               If(~self.empty,
                                                                    If(self.rd_ptr[0: -1] < ((k_loop_read + 1 + l + two_block_read + count9K_read)*memory)*int(data_width_write/data_width_read) + int(starting) - 1,
                                                                      If(self.rd_ptr[0: -1] >= ((k_loop_read + l + two_block_read + count9K_read)*memory)*int(data_width_write/data_width_read) + int(starting) - 1,
                                                                        self.rden_int[count + l].eq(1)
                                                                        ).Else(self.rden_int[count + l].eq(0))
                                                                    ).Else(self.rden_int[count + l].eq(0))
                                                                ).Else(self.rden_int[count + l].eq(0))
                                                    ...
                                                    self.sync.rd += [
                                                        If(self.rd_en_flop1,
                                                           If(~self.underflow,
                                                                If(self.rd_ptr[0: -1] < ((k_loop_read + 1 + l + two_block_read + count9K_read)*memory)*int(data_width_write/data_width_read) + int(starting),
                                                                  If(self.rd_ptr[0: -1] >= ((k_loop_read + l + two_block_read + count9K_read)*memory)*int(data_width_write/data_width_read) + int(starting),
                                                                        self.dout[j:data_read + j].eq(self.dout_int[count + l])
                                                                )
                                                              )
                                                ...
                                                if (k9_flag_read):
                                                    if ((count + l + count_36K == 0) or (count_36K > 0 and l == 0 and (count18K_read == 0))):
                                                        self.sync.rd += [
                                                            If(self.rden,
                                                               If(~self.empty,
                                                                    If(self.rd_ptr[0: -1] < ((k_loop_read + 1 + l + count18K_read + count9K_read)*read_memory) + int(starting) - 1,
                                                                      If(self.rd_ptr[0: -1] >= ((k_loop_read + l + count18K_read + count9K_read)*read_memory) + int(starting),
                                                                        self.rden_int[count + l].eq(1)
                                                                        ).Else(self.rden_int[count + l].eq(0))
                                                                    ).Elif(self.rd_ptr[0: -1] == int(ending),
                                                                               self.rden_int[count + l].eq(1)
                                                        ...
                                                        self.sync.rd += [
                                                            If(self.rden,
                                                               If(~self.empty,
                                                                    If(self.rd_ptr[0: -1] < ((k_loop_read + 1 + l + count18K_read + count9K_read)*read_memory) + int(starting) - 1,
                                                                      If(self.rd_ptr[0: -1] >= ((k_loop_read + l + count18K_read + count9K_read)*read_memory) + int(starting) - 1,
                                                                        self.rden_int[count + l].eq(1)
                                                                        ).Else(self.rden_int[count + l].eq(0))
                                                                    ).Else(self.rden_int[count + l].eq(0))
                                                                ).Else(self.rden_int[count + l].eq(0))
                                                    ...
                                                    self.sync.rd += [
                                                        If(self.rd_en_flop1,
                                                           If(~self.underflow,
                                                                If(self.rd_ptr[0: -1] < ((k_loop_read + 1 + l + count18K_read + count9K_read)*read_memory) + int(starting),
                                                                  If(self.rd_ptr[0: -1] >= ((k_loop_read + l + count18K_read + count9K_read)*read_memory) + int(starting),
                                                                        self.dout[j:data_read + j].eq(self.dout_int[count + l])
                                                                )
                                                              )
                                                    ...
                                                    if ((count + l + count_36K == 0) or (count_36K > 0 and l == 0 and (count18K_read + count9K_read == 0))):
                                                        self.sync.rd += [
                                                            If(self.rden,
                                                               If(~self.empty,
                                                                    If(self.rd_ptr[0: -1] < ((k_loop_read + 1 + l + count18K_read)*read_memory) + int(starting) - 1,
                                                                      If(self.rd_ptr[0: -1] >= ((k_loop_read + l + count18K_read)*read_memory) + int(starting),
                                                                        self.rden_int[count + l].eq(1)
                                                                        ).Else(self.rden_int[count + l].eq(0))
                                                                    ).Elif(self.rd_ptr[0: -1] == int(ending),
                                                                               self.rden_int[count + l].eq(1)
                                                        ...
                                                        self.sync.rd += [
                                                            If(self.rden,
                                                               If(~self.empty,
                                                                    If(self.rd_ptr[0: -1] < ((k_loop_read + 1 + l + count18K_read)*read_memory) + int(starting) - 1,
                                                                      If(self.rd_ptr[0: -1] >= ((k_loop_read + l + count18K_read)*read_memory) + int(starting)- 1,
                                                                        self.rden_int[count + l].eq(1)
                                                                        ).Else(self.rden_int[count + l].eq(0))
                                                                    ).Else(self.rden_int[count + l].eq(0))
                                                                ).Else(self.rden_int[count + l].eq(0))
                                                    ...
                                                    self.sync.rd += [
                                                        If(self.rd_en_flop1,
                                                           If(~self.underflow,
                                                                If(self.rd_ptr[0: -1] <= ((k_loop_read + 1 + l + count18K_read)*read_memory) + int(starting),
                                                                  If(self.rd_ptr[0: -1] >= ((k_loop_read + l + count18K_read)*read_memory) + int(starting),
                                                                        self.dout[j:data_read + j].eq(self.dout_int[count + l])
                                                                )
                                                              )
                                                ...
                                                if (data_read == 9):
                                                    if (k18_flag_read):
                                                        ...
                                                        self.sync.rd += [
                                                            If(~self.rden,
                                                                If(~self.empty_int[count + l],
                                                                    If(self.rd_ptr[0: -1] <= int((k_loop_read + 1 + l + two_block_read + count9K_read)*memory*int(data_width_write/data_width_read)) + int(starting),
                                                                        If(self.rd_ptr[0: -1] >= int((k_loop_read + l + two_block_read + count9K_read)*memory*int(data_width_write/data_width_read)) + int(starting),
                                                                            self.dout[j:data_read + j].eq(self.dout_int[count + l]
                                                                            )
                                                                        )
                                                                    )
                                                    ...
                                                    if (k9_flag_read):
                                                        self.sync.rd += [
                                                            If(~self.rden,
                                                                If(~self.empty_int[count + l],
                                                                    If(self.rd_ptr[0: -1] <= int((k_loop_read + 1 + l + count18K_read + count9K_read)*read_memory) + int(starting),
                                                                        If(self.rd_ptr[0: -1] >= int((k_loop_read + l + count18K_read + count9K_read)*read_memory) + int(starting),
                                                                            self.dout[j:data_write + j].eq(self.dout_int[count + l]
                                                                            )
                                                                        )
                                                                    )
                                                        ...
                                                        self.sync.rd += [
                                                            If(~self.rden,
                                                                If(~self.empty_int[count + l],
                                                                    If(self.rd_ptr[0: -1] <= int((k_loop_read + 1 + l + count18K_read)*read_memory) + int(starting),
                                                                        If(self.rd_ptr[0: -1] >= int((k_loop_read + l + count18K_read)*read_memory) + int(starting),
                                                                            self.dout[j:data_write + j].eq(self.dout_int[count + l]
                                                                            )
                                                                        )
                                                                    )
                    ...
                    self.comb += [
                        If(self.rden,
                           self.rd_ptr_minus.eq(self.rd_ptr - 1)
                               ...
                               self.rd_ptr_minus.eq(self.rd_ptr)
                           )
                        ]
                else:
                    self.comb += [
                        If(self.rden,
                           self.rd_ptr_add.eq(self.rd_ptr + 1)
                               ...
                               self.rd_ptr_add.eq(self.rd_ptr)
                           )
                    ]
            if (not SYNCHRONOUS[synchronous]):
                if (data_width_write > data_width_read):
                    self.wrt_pointer_multiple = Signal(math.ceil(math.log2((data_width_write/data_width_read)*depth)) + 2, reset=0)
                    self.comb += self.wrt_pointer_multiple[0: -1].eq(self.wrt_ptr[0: -1]*(int(data_width_write/(data_width_write if data_width_write == data_width_read else data_width_read))))
                    ...
                    self.comb += self.sync_rdclk_wrtptr_binary_multiple[0:-1].eq(self.sync_rdclk_wrtptr_binary[0:-1]*(int(data_width_write/(data_width_write if data_width_write == data_width_read else data_width_read))))
                    ...
                    self.comb += self.sync_wrtclk_rdptr_binary_div.eq((self.sync_wrtclk_rdptr_binary + decimal_to_binary(int(data_width_write/(data_width_write if data_width_write == data_width_read else data_width_read)))) >> (decimal_to_binary(int(data_width_write/(data_width_write if data_width_write == data_width_read else data_width_read)))) << (decimal_to_binary(int(data_width_write/(data_width_write if data_width_write == data_width_read else data_width_read)))))
                                                ...
                                                self.sync.rd += [
                                                    If(self.rden,
                                                       If(~self.empty,
                                                          ...
                                                          .Elif(self.rd_ptr[0: -1] == int(ending + 1),
                                                                   self.rden_int[i].eq(1)
                                                                   )
                                                          .Else(
                                                            self.rden_int[i].eq(0)
            ...
            if (data_width_write >= data_width_read):
                self.pessimistic_full = Signal(int(data_width_write/(data_width_write if data_width_write == data_width_read else data_width_read)))
            ...
            if(SYNCHRONOUS[synchronous]):
                ...
                if (data_width_write >= data_width_read):
                    ...
                    self.sync += [
                        If(self.counter <= int(data_width_write/data_width_read)*(depth) + 1,
                           If(self.counter > int(data_width_write/data_width_read)*(depth) - int(data_width_write/(data_width_write if data_width_write == data_width_read else data_width_read)),
                           If(self.rden,
                    ...
                    self.comb += [
                        If(self.counter >= int(data_width_write/data_width_read)*(depth),
                           self.full.eq(1)
                        ).Elif(self.pessimistic_full <= int(data_width_write/(data_width_write if data_width_write == data_width_read else data_width_read) - 1),
                ...
                if (data_width_write > data_width_read):
                    # Checking if the FIFO is full pessismistically
                    self.sync.wrt += [
                        If((self.wrt_pointer_multiple[-1] != self.sync_wrtclk_rdptr_binary_div[-1]),
                            If(self.rden,
                               If(self.pessimistic_full < int(data_width_write/(data_width_write if data_width_write == data_width_read else data_width_read)),
                             self.pessimistic_full.eq(self.pessimistic_full + 1)
                            )
                            ).Else(
                                self.pessimistic_full.eq(0)
                    ...
                    self.comb += [
                        If((self.wrt_pointer_multiple[-1] != self.sync_wrtclk_rdptr_binary_div[-1]),
                            If(self.wrt_pointer_multiple[0: -1] == self.sync_wrtclk_rdptr_binary_div[0: -1],
                               self.full.eq(1)
                               ).Elif(self.pessimistic_full <= int(data_width_write/(data_width_write if data_width_write == data_width_read else data_width_read) - 1),
                            If(self.pessimistic_full > 0,
                               self.full.eq(1)
                    ...
                    if (full_threshold):
                        self.comb += [
                            If(self.wrt_pointer_multiple[0: -1] +  (int(ending) - int((data_width_write/data_width_read)*full_value + int(starting))) - self.sync_wrtclk_rdptr_binary[0: -1] < (int(ending) - int((data_width_write/data_width_read)*full_value + int(starting))),
                                self.prog_full.eq(1)
                            )
                        ]
                        self.comb += [
                        ...
                        self.comb += [
                            If(self.wrt_pointer_multiple[0: -1] +  (int(ending) - int((data_width_write/data_width_read)*full_value + int(starting))) >= int(ending),
                               self.wrt_ptr_reg_multiple[0: -1].eq(int(starting)),
                               self.wrt_ptr_reg_multiple[-1].eq(self.wrt_pointer_multiple[-1]),
                               If(self.wrt_ptr_reg_multiple[0: -1] == self.sync_wrtclk_rdptr_binary[0: -1],
                               self.prog_full.eq(1)
                               )
                            ).Else(
