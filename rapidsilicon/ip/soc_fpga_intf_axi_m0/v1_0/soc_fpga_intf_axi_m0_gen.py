...
from litex_wrapper.soc_fpga_intf_axi_m0_litex_wrapper import SOC_FPGA_INTF_AXI_M0
...
class AXIM0Wrapper(Module):
    def __init__(self, platform, data_width, addr_width, id_width):
        ...
        platform.add_extension(axi.get_ios("M0"))
        self.comb += axi.connect_to_pads(platform.request("M0"), mode="master")

        # AXI-RAM ----------------------------------------------------------------------------------
        self.submodules += SOC_FPGA_INTF_AXI_M0(platform, axi)
